-- Allow each team to be assigned to up to TWO color groups
-- so judges from both groups evaluate the same team (dual evaluation).
...
-- QR lookup: aggregate all assigned groups (up to two)
